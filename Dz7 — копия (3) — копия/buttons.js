...
htmlElements.input = document.querySelector("div.container-timer input[id=newTime]")
htmlElements.changer = document.querySelector("div.container-timer button[id=changer]")
htmlElements.ok = document.querySelector("div.container-timer button[id=ok]")
htmlElements.cancel = document.querySelector("div.container-timer button[id=cancel]")
...
document.getElementById("button3").onclick = function() {
    ...
    htmlElements.changer.addEventListener("click", () => htmlElements.input.removeAttribute("hidden"))
    htmlElements.changer.addEventListener("click", () => htmlElements.cancel.removeAttribute("disabled"))
    htmlElements.changer.addEventListener("click", () => htmlElements.ok.removeAttribute("disabled"))
    htmlElements.changer.addEventListener("click", timer.changer)
    htmlElements.ok.addEventListener("click", timer.save)
};